...
public class ResponseSuccessUtil {
    ...
    public static ResponseEntity<Object> ok(HttpServletRequest request, Message message) {
        return getResponseEntity(request, HttpStatus.OK, message, null);
    }

    public static ResponseEntity<Object> ok(HttpServletRequest request, Object content) {
        return getResponseEntity(request, HttpStatus.OK, WebMessageImpl.SUCCESS_WEB_GET, content);
    }

    public static ResponseEntity<Object> ok(HttpServletRequest request, Message message, Object content) {
        return getResponseEntity(request, HttpStatus.OK, message, content);
    }

    public static ResponseEntity<Object> created(HttpServletRequest request) {
        return getResponseEntity(request, HttpStatus.CREATED, WebMessageImpl.SUCCESS_WEB_POST, null);
    }

    public static ResponseEntity<Object> patched(HttpServletRequest request) {
        return getResponseEntity(request, HttpStatus.CREATED, WebMessageImpl.SUCCESS_WEB_PATCH, null);
    }

    public static ResponseEntity<Object> deleted(HttpServletRequest request) {
        return getResponseEntity(request, HttpStatus.CREATED, WebMessageImpl.SUCCESS_WEB_DELETE, null);
    }

    private static ResponseEntity<Object> getResponseEntity(HttpServletRequest request, HttpStatus httpStatus, Message message, Object content) {
