...
const Logo = () => {
    ...
    return (
        <Grid id={styles.logo} item xs="auto">
            <svg id={styles.svg} className={commonStyles.displayBlock} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 886.000000 885.000000">
                <g transform="translate(0.000000,885.000000) scale(0.100000,-0.100000)" fill={palette.primary.main}>
